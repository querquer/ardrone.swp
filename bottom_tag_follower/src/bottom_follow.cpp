...
void handleTag(const ar_recog::Tags::ConstPtr& msg)
{
  ...
  if((Cglobal::instance().vx > 0 && Cglobal::instance().twist.linear.x < 0) || (Cglobal::instance().vx < 0 && Cglobal::instance().twist.linear.x > 0))
  {
	  Cglobal::instance().twist.linear.x -= 1 * (Cglobal::instance().vx / 4000);
  }
  if((Cglobal::instance().vy > 0 && Cglobal::instance().twist.linear.y < 0) || (Cglobal::instance().vy < 0 && Cglobal::instance().twist.linear.y > 0))
  {
  ...
  if(Cglobal::instance().twist.linear.x * Cglobal::instance().vx > 0 && abs(Cglobal::instance().twist.linear.x) * 5000 < abs(Cglobal::instance().vx))
  {
  ...
  if(Cglobal::instance().twist.linear.y * Cglobal::instance().vy > 0 && abs(Cglobal::instance().twist.linear.y) * 5000 < abs(Cglobal::instance().vy))
  {
